export default {
    "db-config": {
        "sd_DbjywM4edN2Z427p": {
            ...
            "postgres_host": "139.59.247.177",
            "postgres_port": 5432,
            "postgres_username": "postgres",
            "postgres_password": "@D3lt44pp1234*",
            "postgres_database": "ima_noufan",
            ...
            "users": {
                "SSD_SERVICE_ID_sd_MUdlV6pRD2JcsC2a": [
                    "sd_4paPQGnN6Hp2ZSgp",
                    "sd_x98oyEaEIzbOLldW",
                    "sd_eRliwBs8XRMv5X8u"
                ]
